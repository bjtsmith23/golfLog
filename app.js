...
const firebaseConfig = {
  apiKey: "AIzaSyDRX3mvnC8lt421adt5E-mR_BZAi12nE9o",
  authDomain: "killer-4a6c8.firebaseapp.com",
  databaseURL: "https://killer-4a6c8-default-rtdb.firebaseio.com",
  projectId: "killer-4a6c8",
  storageBucket: "killer-4a6c8.firebasestorage.app",
  messagingSenderId: "138779791827",
  appId: "1:138779791827:web:7bb061ba66436a95f05f26",
  measurementId: "G-HG6QD68HJV"
};
...
function showCourseSelect() {
  ...
  // Retrieve courses from Firebase using db
  db.ref('courses').once('value').then(snapshot => {
    ...
    keys.forEach((key, index) => {
      ...
      option.value = key; // use Firebase key for reference
